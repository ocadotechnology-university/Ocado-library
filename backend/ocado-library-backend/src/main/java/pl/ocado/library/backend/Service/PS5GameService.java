...
public class PS5GameService implements PS5GameInterface {
    ...
    public void updatePS5Game(PS5Game ps5Game) {
        ...
        existingPS5Game.setDescription(ps5Game.getDescription());
        existingPS5Game.setStatus(ps5Game.getStatus());
        existingPS5Game.setBorrower(ps5Game.getBorrower());
        existingPS5Game.setBorrowingDate(ps5Game.getBorrowingDate());
