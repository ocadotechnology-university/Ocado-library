...
function StatCard({
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-[#b1b2b5]/60 bg-[#eeeef0]/90 px-3 py-2.5 shadow-sm">
      <span
        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#43485e]/10 text-lg"
        aria-hidden
      >
        {icon}
      </span>
  ...
  return (
    <SidebarTemplate>
      <div className="rounded-xl bg-gradient-to-br from-[#43485e] via-[#3d4258] to-[#323746] p-4 shadow-[inset_0_1px_0_0_rgb(255_255_255_/0.08)]">
        <p className="text-center text-[10px] font-bold uppercase tracking-[0.2em] text-[#d4e157]">
          Library pulse
        </p>
        <div
